...
SUPABASE_URL = os.environ.get('SUPABASE_URL', 'https://ljzypuiqebttfmmgzsqk.supabase.co')
SUPABASE_PUBLISHABLE_KEY = os.environ.get('SUPABASE_PUBLISHABLE_KEY', os.environ.get('SUPABASE_KEY', ''))
SUPABASE_SECRET_KEY = os.environ.get('SUPABASE_SECRET_KEY', '')
SUPABASE_SERVER_KEY = os.environ.get('SUPABASE_SERVER_KEY', SUPABASE_SECRET_KEY or SUPABASE_PUBLISHABLE_KEY)

# Backward-compatible name used by existing templates and frontend scripts.
